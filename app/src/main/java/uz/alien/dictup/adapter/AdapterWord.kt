...
import uz.alien.dictup.activity.DetailsActivity
import uz.alien.dictup.databinding.ItemWordBinding
import uz.alien.dictup.model.Word

class AdapterWord(private val activity: BaseActivity, private val words: List<Word>) : RecyclerView.Adapter<AdapterWord.WordViewHolder>() {
