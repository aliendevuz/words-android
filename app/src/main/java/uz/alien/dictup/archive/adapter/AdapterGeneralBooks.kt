...
class AdapterGeneralBooks(
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterGeneralBooks.GeneralBooksViewHolder {
    return GeneralBooksViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.page_books, parent, false))
  }

  override fun getItemCount() = 2

  override fun onBindViewHolder(holder: AdapterGeneralBooks.GeneralBooksViewHolder, position: Int) {
