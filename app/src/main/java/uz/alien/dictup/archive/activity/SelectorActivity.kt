...
class SelectorActivity : ActivityBase() {
  ...
  override fun onReady(savedInstanceState: Bundle?) {
    ...
    val vpAdapter =
      uz.alien.dictup.archive.adapter.AdapterGeneralBooks(2, this, dp(), pick, size, binding.vpBook)
